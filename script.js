"use strict"
const TOKEN =
  "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..hwEDPv9jP0fedeRY-7l_s0wnTAYtif6-obzZSUDpX44"
let symptoms
let dictionary = []
let options = []
let diseases = []
      ...
      for (let i = 0; i < diseases.length; i++) {
        ...
        const template = `
                <div class="card">
                    ...
                    <p>You should consult the doctor having speciality in ${specialist[i]}</p>
                    <button class="btn" onclick="">Find a doctor</button>
                </div>
                    `
        cards.push(template)
      }
